...
const textProps = {
  ...
  cards: [
    ...
    {
      image: require("assets/img/faces/team-3.jpg"),
      ...
      user: require("assets/img/faces/michael.jpg"),
      username: "Paul Smith",
      userlink: {
        href: "#pablo",
      },
    ...
    {
      image: require("assets/img/faces/team-4.jpg"),
      ...
      user: require("assets/img/faces/team-1.jpg"),
